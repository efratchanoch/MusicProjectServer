...
public class PdfTextExtractorService {
    ...
    public PdfTextExtractorService() {
        // מגדירים משתנה סביבה פנימי כדי Tesseract ידע איפה הקבצים
        System.setProperty("TESSDATA_PREFIX", "C:\\Program Files\\Tesseract-OCR\\tessdata");


        tess = new Tesseract();
        tess.setDatapath("C:\\Program Files\\Tesseract-OCR\\tessdata"); // רק התיקייה שבה שמרת את הקבצים
        tess.setLanguage("heb+eng"); // heb for Hebrew + eng
